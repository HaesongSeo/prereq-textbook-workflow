...
% "Chapter plan".  chapters/ch00-example.tex is the format to copy -- it is a
% template, so it is not included here.
...
% "Phase 5 order".  The format to copy is paper/sec00-example.tex.
